...
import { Download, ArrowRight, Zap, Award, Cloud } from 'lucide-react';
...
export default function HomeBillboard() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Bottom bleed gradient — flows into first ContentRow */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <Link href="/experience" className="btn-primary flex items-center gap-2 group px-8">
            View Experience
